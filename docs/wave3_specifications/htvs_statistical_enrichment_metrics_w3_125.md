# AETHER Scientific Specification: Htvs Statistical Enrichment Metrics (W3_125)

## Overview
Information-theoretic bounds on virtual screening Enrichment Factor and ROC-AUC
