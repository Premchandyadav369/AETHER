# AETHER Scientific Specification: Macrocyclic Conformational Sampling (W3_116)

## Overview
Distance Geometry and Monte Carlo conformational search for macrocyclic rings
