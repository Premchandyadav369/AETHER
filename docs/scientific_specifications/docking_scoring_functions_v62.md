# AETHER Scientific Specification: Docking Scoring Functions (V62)

## Overview
Comparative benchmark analysis of empirical vs machine-learned docking potentials
...
- Specification Code: `ATH-SPEC-V62`
