# AETHER Scientific Specification: Free Energy Perturbation Theory (V12)

## Overview
Theoretical derivation of thermodynamic cycles for alchemical free energy
...
- Specification Code: `ATH-SPEC-V12`
