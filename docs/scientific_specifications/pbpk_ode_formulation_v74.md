# AETHER Scientific Specification: Pbpk Ode Formulation (V74)

## Overview
Formal differential equation system specification for whole-body PBPK dynamics
...
- Specification Code: `ATH-SPEC-V74`
