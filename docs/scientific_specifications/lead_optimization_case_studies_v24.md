# AETHER Scientific Specification: Lead Optimization Case Studies (V24)

## Overview
Retrospective medicinal chemistry case studies on EGFR and KRAS inhibitors
...
- Specification Code: `ATH-SPEC-V24`
