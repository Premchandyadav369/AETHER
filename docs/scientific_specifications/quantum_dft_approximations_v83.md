# AETHER Scientific Specification: Quantum Dft Approximations (V83)

## Overview
Computational chemistry methodology notes on B3LYP exchange-correlation functional
...
- Specification Code: `ATH-SPEC-V83`
