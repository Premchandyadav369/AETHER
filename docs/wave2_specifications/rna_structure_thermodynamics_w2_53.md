# AETHER Scientific Specification: Rna Structure Thermodynamics (W2_53)

## Executive Summary
Nearest-neighbor thermodynamic parameters (Turner rules) for RNA folding
