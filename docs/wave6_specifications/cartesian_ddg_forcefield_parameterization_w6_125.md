# PROTEUS Scientific Specification: Cartesian Ddg Forcefield Parameterization (W6_125)

## Overview
Empirical scoring functions for protein stability and pathogenic mutation prediction
...
- **Specification ID**: `ATH-W6-W6_125`
