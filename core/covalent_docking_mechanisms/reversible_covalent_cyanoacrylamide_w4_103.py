"""
AETHER Covalent Docking Core: Reversible Covalent Cyanoacrylamide (w4_103)
Implement alpha-cyanoacrylamide reversible covalent dissociation constant Koff
"""
...
class ReversibleCovalentCyanoacrylamideModelerW4103:
    """Implement alpha-cyanoacrylamide reversible covalent dissociation constant Koff."""
    ...
    def calculate_inactivation_efficiency(self) -> Dict[str, Any]:
        ...
        return {
            "modeler": "reversible_covalent_cyanoacrylamide",
