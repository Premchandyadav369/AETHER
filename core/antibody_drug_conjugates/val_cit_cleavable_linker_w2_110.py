"""
AETHER Biologics & ADC Core: Val Cit Cleavable Linker (w2_110)
Implement Valine-Citrulline dipeptide Cathepsin-B enzymatic cleavage kinetics
"""
...
class ValCitCleavableLinkerModelW2110:
    """Implement Valine-Citrulline dipeptide Cathepsin-B enzymatic cleavage kinetics."""
    ...
    def simulate_conjugate(self, dar: float = 3.8) -> Dict[str, Any]:
        ...
        return {
            "model": "val_cit_cleavable_linker",
