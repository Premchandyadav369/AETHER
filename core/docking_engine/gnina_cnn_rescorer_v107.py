"""
AETHER Docking Core: Gnina Cnn Rescorer (v107)
Implement 3D convolutional neural net voxelized pose affinity predictor
"""
...
class GninaCnnRescorerEvaluatorV107:
    """Implement 3D convolutional neural net voxelized pose affinity predictor."""
