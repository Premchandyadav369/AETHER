"""
AETHER CRISPR & Gene Editing Core: Cas9 Spcas9 Pam Finder (w2_25)
Implement SpCas9 NGG protospacer adjacent motif (PAM) genomic locus finder
"""
...
class Cas9Spcas9PamFinderOptimizerW225:
    """Implement SpCas9 NGG protospacer adjacent motif (PAM) genomic locus finder."""
    ...
    def evaluate_guide(self, protospacer_20nt: str) -> Dict[str, Any]:
        ...
        return {
            "optimizer": "cas9_spcas9_pam_finder",
