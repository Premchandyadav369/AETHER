"""
AETHER FEP+ Core: Grand Canonical Water Monte Carlo (w4_118)
Implement Grand Canonical Monte Carlo (GCMC) hydration displacement free energies
"""
...
class GrandCanonicalWaterMonteCarloEngineW4118:
    """Implement Grand Canonical Monte Carlo (GCMC) hydration displacement free energies."""
    ...
    def compute_relative_delta_delta_g(self, ligand_a: str, ligand_b: str) -> Dict[str, Any]:
        ...
        return {
            "engine": "grand_canonical_water_monte_carlo",
