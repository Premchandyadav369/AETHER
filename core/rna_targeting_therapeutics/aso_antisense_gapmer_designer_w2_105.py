"""
AETHER RNA Therapeutics Core: Aso Antisense Gapmer Designer (w2_105)
Implement phosphorothioate locked nucleic acid (LNA) RNase-H gapmer score
"""
...
class AsoAntisenseGapmerDesignerEngineW2105:
    """Implement phosphorothioate locked nucleic acid (LNA) RNase-H gapmer score."""
    ...
    def fold_and_bind(self, sequence: str) -> Dict[str, Any]:
        ...
        return {
            "engine": "aso_antisense_gapmer_designer",
