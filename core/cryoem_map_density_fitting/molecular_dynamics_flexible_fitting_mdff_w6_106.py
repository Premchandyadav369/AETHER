"""
PROTEUS Cryo-EM Core: Molecular Dynamics Flexible Fitting Mdff (w6_106)
Implement MDFF density-derived steering forces for flexible domain fitting
"""
...
class MolecularDynamicsFlexibleFittingMdffFitterW6106:
    """Implement MDFF density-derived steering forces for flexible domain fitting."""
    ...
    def fit_atomic_model(self) -> Dict[str, Any]:
        ...
        return {
            "fitter": "molecular_dynamics_flexible_fitting_mdff",
