"""
AETHER Cheminformatics Engine: Nih Filter (v51)
Implement NIH molecular screening deck exclusion criteria ruleset
"""
...
def run_descriptor_pipeline_nih_filter_v51(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = NihFilterEngineV51()
