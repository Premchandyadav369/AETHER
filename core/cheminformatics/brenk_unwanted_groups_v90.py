"""
AETHER Cheminformatics Engine: Brenk Unwanted Groups (v90)
...
class BrenkUnwantedGroupsEngineV90:
    """Implement Brenk unwanted functional group and chemical reactivity filter."""
...
def run_descriptor_pipeline_brenk_unwanted_groups_v90(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = BrenkUnwantedGroupsEngineV90()
