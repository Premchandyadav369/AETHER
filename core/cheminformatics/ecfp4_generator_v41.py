"""
AETHER Cheminformatics Engine: Ecfp4 Generator (v41)
...
def run_descriptor_pipeline_ecfp4_generator_v41(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = Ecfp4GeneratorEngineV41()
