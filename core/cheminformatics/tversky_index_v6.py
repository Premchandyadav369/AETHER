"""
AETHER Cheminformatics Engine: Tversky Index (v6)
...
def run_descriptor_pipeline_tversky_index_v6(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = TverskyIndexEngineV6()
