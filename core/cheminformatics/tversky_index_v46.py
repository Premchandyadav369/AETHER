"""
AETHER Cheminformatics Engine: Tversky Index (v46)
...
def run_descriptor_pipeline_tversky_index_v46(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = TverskyIndexEngineV46()
