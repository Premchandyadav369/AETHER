"""
AETHER Cheminformatics Engine: Veber Rules (v14)
Implement Veber oral bioavailability rules (rotatable bonds <= 10, TPSA <= 140)
"""
...
def run_descriptor_pipeline_veber_rules_v14(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = VeberRulesEngineV14()
