"""
AETHER Cheminformatics Engine: Esol Solubility (v21)
...
def run_descriptor_pipeline_esol_solubility_v21(smiles_list: List[str]) -> List[Dict[str, Any]]:
    engine = EsolSolubilityEngineV21()
