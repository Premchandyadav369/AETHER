"""
AETHER Wave 5 Test Suite: Test Disease Preset Crystal Complex Load (w5_108)
...
def test_wave5_module_test_disease_preset_crystal_complex_load_w5_108():
...
def test_wave5_consistency_test_disease_preset_crystal_complex_load_w5_108():
