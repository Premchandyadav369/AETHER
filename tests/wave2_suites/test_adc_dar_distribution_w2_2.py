"""
AETHER Wave 2 Test Suite: Test Adc Dar Distribution (w2_2)
...
def test_wave2_integrity_test_adc_dar_distribution_w2_2():
...
def test_wave2_numerical_tolerance_test_adc_dar_distribution_w2_2():
