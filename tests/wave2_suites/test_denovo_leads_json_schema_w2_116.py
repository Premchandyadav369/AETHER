"""
AETHER Wave 2 Test Suite: Test Denovo Leads Json Schema (w2_116)
...
def test_wave2_integrity_test_denovo_leads_json_schema_w2_116():
...
def test_wave2_numerical_tolerance_test_denovo_leads_json_schema_w2_116():
