"""
AETHER Wave 3 Test Suite: Test Comfa 3D Grid Potentials (w3_1)
...
def test_wave3_module_test_comfa_3d_grid_potentials_w3_1():
...
def test_wave3_reproducibility_test_comfa_3d_grid_potentials_w3_1():
