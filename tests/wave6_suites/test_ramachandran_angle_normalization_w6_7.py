"""
PROTEUS Wave 6 Test Suite: Test Ramachandran Angle Normalization (w6_7)
...
def test_wave6_module_test_ramachandran_angle_normalization_w6_7():
...
def test_wave6_numeric_bounds_test_ramachandran_angle_normalization_w6_7():
