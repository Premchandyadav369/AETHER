"""
PROTEUS Wave 6 Test Suite: Test Surface Mesh Watertightness (w6_23)
...
def test_wave6_module_test_surface_mesh_watertightness_w6_23():
...
def test_wave6_numeric_bounds_test_surface_mesh_watertightness_w6_23():
