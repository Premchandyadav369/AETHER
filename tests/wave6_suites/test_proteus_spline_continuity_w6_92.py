"""
PROTEUS Wave 6 Test Suite: Test Proteus Spline Continuity (w6_92)
...
def test_wave6_module_test_proteus_spline_continuity_w6_92():
...
def test_wave6_numeric_bounds_test_proteus_spline_continuity_w6_92():
