"""
PROTEUS Wave 6 Test Suite: Test Cryoem Fsc Half Map Correlation (w6_96)
...
def test_wave6_module_test_cryoem_fsc_half_map_correlation_w6_96():
...
def test_wave6_numeric_bounds_test_cryoem_fsc_half_map_correlation_w6_96():
