"""
PROTEUS Wave 6 Test Suite: Test Fpocket Alpha Sphere Clustering (w6_17)
...
def test_wave6_module_test_fpocket_alpha_sphere_clustering_w6_17():
...
def test_wave6_numeric_bounds_test_fpocket_alpha_sphere_clustering_w6_17():
